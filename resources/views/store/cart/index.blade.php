...
<div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-2xl p-10 text-center ring-1 ring-gray-100 shadow-sm">
        <div class="text-2xl font-semibold mb-2">Giỏ hàng trống</div>
        <p class="text-gray-500 mb-6">Bạn chưa có sản phẩm nào. Hãy khám phá các ưu đãi hấp dẫn nhé!</p>
        <a href="{{ route('home') }}" class="inline-flex h-11 px-6 rounded-full bg-indigo-600 text-white font-medium hover:bg-indigo-700">
            Mua sắm ngay
        </a>
    </div>
    @else
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="flex items-center gap-3 text-[#0D2E69] bg-blue-50 rounded-2xl px-4 py-3 ring-1 ring-blue-100">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M3 7h13v7h-1.34a3.99 3.99 0 0 0-7.32 0H6V9H3V7zm18 4h-3V9h2l1 2zM8 18a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm10 0a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" />
                </svg>
            ...
            <div class="bg-white rounded-2xl ring-1 ring-gray-100 shadow-sm p-4 sm:p-5">
                ...
                <div class="mt-4">
                    ...
                    <textarea id="note" name="note" rows="3"
                        class="mt-2 w-full rounded-xl border-gray-200 focus:border-indigo-300 focus:ring-indigo-200"
